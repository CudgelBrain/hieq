...
const PersonalInfo :React.FC= () => {
    ...
    return(
        <>
              ...
              <button className="plus-btn" type="button" onChange={()=>{toggleAccordion()}}><img src={downArrow} width="20"
                        ...
                        <div className="row">
                            <div className="row">
                              <div className="form-group col-12">
                                ...
                                <input type="text" className="form-control" onChange={handleNameChange} disabled/>
                              </div>
                              <div className="col-12">
                                <div className="form-row">
                                  <div className="form-group col-sm-6">
                                    <label className="label mb-1">Email Address<span className="required">*</span></label>
                                    <input type="text" className="form-control" onChange={handleEmailChange} disabled/>
                                  </div>
                                  <div className="form-group col-sm-6">
                                    <label className="label mb-1">Contact Number<span className="required">*</span></label>
                                    <input type="text" className="form-control" onChange={handlePhChange} disabled/>
                                  </div>
                                  <div className="form-group col-sm-6">
                                  ...
                                  <div className="form-group col-sm-6">
                                    ...
                                    <div className="input-group input-append disabled">
                                      <input type="text" className="form-control" onChange={handledobChange} disabled/>
                          ...
                          <div className="form-group col-12">
                            ...
                            <textarea rows={4} className="form-control" onChange={handleSummaryChange}/>
                          </div>
                        </div>}
                      </div> 
        </>
