      ...
      <div className='col-md-12'>
        <ul className='analytics-list'>
          <li onClick={() => setActiveStatus("active")} style={{ cursor: 'pointer' }}>
            <div className='cf-medium cc-grey mb-2'>Applied</div>
            <div className='cf-large cc-dark fw-600'>{status?.active.count ? status?.active.count : 0}</div>
          ...
          <li onClick={() => setActiveStatus("draft")} style={{ cursor: 'pointer' }}>
            <div className='cf-medium cc-grey mb-2'>Awaiting</div>
          ...
          <li onClick={() => setActiveStatus("closed")} style={{ cursor: 'pointer' }}>
            <div className='cf-medium cc-grey mb-2'>In-Progress</div>
            <div className='cf-large cc-blue fw-600'>{status?.closed.count ? status?.closed.count : 0}</div>
            {/* <div className='cf-medium cc-grey'>{status?.closed.week ? status?.closed.week : 0} from last week</div> */}
          </li>
          <li>
            <div className='cf-medium cc-grey mb-2'>Selected</div>
            <div className='cf-large cc-green fw-600'>05</div>
          </li>
          <li>
            <div className='cf-medium cc-grey mb-2'>Withdrawn</div>
            <div className='cf-large cc-dark fw-600'>05</div>
          </li>
          <li>
            <div className='cf-medium cc-grey mb-2'>Rejected</div>
